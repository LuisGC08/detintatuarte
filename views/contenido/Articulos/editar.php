...
<div class="container-fluid">
    ...
    <form action="index.php?controller=articulos&action=editar" class="form-neon" autocomplete="off" method="POST" enctype="multipart/form-data">

        <input type="hidden" name="cod_articulo" value="<?= $articulo->getCod_articulo() ?>">
