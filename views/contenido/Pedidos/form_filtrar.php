...
<div class="container-fluid">
    <form class="form-neon" action="index.php?controller=pedidos&action=filtrar" method="POST">
        <div class="container-fluid">
            <div class="row justify-content-md-center">
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        <label for="inputSearch" class="bmd-label-floating">¿Qué pedido estas buscando?</label>
                ...
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="campo" id="item_estado">
                            <option value="cod_pedido" <?= ($campo == "cod_pedido") ? "SELECTED" : "" ?>> Codigo pedido</option>
                            <option value="fecha" <?= ($campo == "fecha") ? "SELECTED" : "SELECTED" ?>> Fecha</option>
